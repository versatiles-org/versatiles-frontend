...
export const frontendConfigs: FrontendConfig<keyof typeof fileDBConfigs>[] = [
	{
		name: 'frontend',
		fileDBs: ['all', 'frontend', 'asset-fonts', 'asset-styles', 'asset-maplibre', 'asset-maplibre-inspect'] // , 'rollup:style-selector'
	},
	{
		name: 'frontend-dev',
		fileDBs: ['all', 'frontend-dev', 'asset-fonts', 'asset-styles', 'asset-maplibre', 'asset-maplibre-inspect'] // , 'rollup:style-selector'
	},
	{
		name: 'frontend-min',
		fileDBs: ['all', 'frontend-min', 'asset-fonts', 'asset-styles', 'asset-maplibre'],
		ignore: [
			'assets/glyphs/*',
