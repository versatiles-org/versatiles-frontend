export default function MaplibreControl(controller, callback) {
	...
	addIconStyles(
		{ name: 'design-maker', svg: "<svg width='23' height='23' fill='#fff' viewBox='0 0 512 512' xmlns='http://www.w3.org/2000/svg'><path d='m224,482c-34,-7 -55,-36 -55,-76 -0,-43 -17,-60 -62,-62C-24,338 12,121 156,50 350,-45 557,162 461,355 418,442 309,500 224,482Zm67,-36C444,416 503,229 394,119 272,-4 64,82 64,258c-0,40 7,48 46,50 60,2 93,36 93,95 0,41 25,53 87,43zm9,-32c-39,-10 -32,-68 8,-68 30,0 46,34 25,58 -6,7 -23,13 -34,10zm70,-105c-39,-10 -32,-68 8,-68 30,0 46,34 25,58 -6,7 -23,13 -34,10zm-246,-70c-39,-10 -32,-68 8,-68 30,0 46,34 25,58 -6,7 -23,13 -34,10zm211,-35c-39,-10 -32,-68 8,-68 30,0 46,34 25,58 -6,7 -23,13 -34,10zM231,166c-39,-10 -32,-68 8,-68 30,0 46,34 25,58 -6,7 -23,13 -34,10z' /></svg>" },
	...
	const btnDesignMaker = createButton('design-maker', 'DesignMaker', e => map.zoomIn({}, { originalEvent: e }));
	...
	if (options.disableDesignMaker) btnDesignMaker.disabled = true;
